...
```hcl
github.com/pbs/terraform-aws-ecs-cron-module?ref=2.1.10
```
...
```hcl
module "cron" {
  source = "github.com/pbs/terraform-aws-ecs-cron-module?ref=2.1.10"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cluster"></a> [cluster](#module\_cluster) | github.com/pbs/terraform-aws-ecs-cluster-module | 0.0.6 |
