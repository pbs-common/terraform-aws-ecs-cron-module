...
```hcl
github.com/pbs/terraform-aws-ecs-cron-module?ref=0.1.2
```
...
```hcl
module "cron" {
  source = "github.com/pbs/terraform-aws-ecs-cron-module?ref=0.1.2"
...
| <a name="module_task"></a> [task](#module\_task) | github.com/pbs/terraform-aws-ecs-task-definition-module | 0.0.2 |
