...
```hcl
github.com/pbs/terraform-aws-ecs-cron-module?ref=2.1.36
```
...
```hcl
module "cron" {
  source = "github.com/pbs/terraform-aws-ecs-cron-module?ref=2.1.36"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cluster"></a> [cluster](#module\_cluster) | github.com/pbs/terraform-aws-ecs-cluster-module | 0.0.21 |
| <a name="module_task"></a> [task](#module\_task) | github.com/pbs/terraform-aws-ecs-task-definition-module | 1.0.19 |
